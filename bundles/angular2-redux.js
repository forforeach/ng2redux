System.register("src/translate.pipe", ["angular2/core", "./translate.service", "angular2/src/facade/lang"], function(exports_1, context_1) {
...
System.register("src/translate.service", ["angular2/core", "angular2/http", "rxjs/Observable", "rxjs/add/observable/of", "rxjs/add/operator/share", "rxjs/add/operator/map", "rxjs/add/operator/merge", "rxjs/add/operator/toArray", "./translate.parser"], function(exports_1, context_1) {
  var __moduleName = context_1 && context_1.id;
  var __decorate = (this && this.__decorate) || function(decorators, target, key, desc) {
    var c = arguments.length,
        r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc,
  ...
  return {
    ...
    }, function(_1) {}, function(_2) {}, function(_3) {}, function(_4) {}, function(_5) {}, function(translate_parser_1_1) {
...
System.register("src/translate.parser", [], function(exports_1, context_1) {
  var __moduleName = context_1 && context_1.id;
  var Parser;
  return {
    setters: [],
...
System.register("angular2-redux", ["angular2/core", "angular2/http", "./src/translate.pipe", "./src/translate.service", "./src/translate.parser"], function(exports_1, context_1) {
  var __moduleName = context_1 && context_1.id;
  var core_1,
      http_1,
      translate_pipe_1,
  ...
  var exportedNames_1 = {'TRANSLATE_PROVIDERS': true};
  ...
  return {
    ...
    execute: function() {
      exports_1("TRANSLATE_PROVIDERS", TRANSLATE_PROVIDERS = [core_1.provide(translate_service_1.TranslateLoader, {
